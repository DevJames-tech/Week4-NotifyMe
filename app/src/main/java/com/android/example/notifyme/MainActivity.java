...
public class MainActivity extends AppCompatActivity {
    ...
    private NotificationCompat.Builder getNotificationBuilder() {
        ...
        NotificationCompat.Builder notifyBuilder = new NotificationCompat.Builder(this, PRIMARY_CHANNEL_ID)
                ...
                .setSmallIcon(R.drawable.ic_android).setAutoCancel(true).setContentIntent(notificationPendingIntent)
    ...
    public void updateNotification() {
        ...
        notifyBuilder.setStyle(new NotificationCompat.BigPictureStyle().bigPicture(androidImage).setBigContentTitle(getString
                (R.string.notification_updated)));
